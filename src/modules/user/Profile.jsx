...
export default class Profile extends Component {
	...
	componentWillUnmount() {
		// console.log('this.state.profile', this.state.images[1]);
		// console.log('this.state.profile', this.state.images.length-1);
	}
			...
			<div>
				{
					this.state.reviewed.map((review, index) =>(
						<ListGroup>
							<ListGroupItem>Restaurant: <Link to={'/restaurants/'+review.split("/")[1]}>{review.split("/")[0]}</Link></ListGroupItem>
							<ListGroupItem>Rating: {review.split("/")[2]}/5</ListGroupItem>
							<ListGroupItem>Review: {review.split("/")[3]}</ListGroupItem>
				  		</ListGroup>
		  		))}
	  		</div>
	  		*/
					...
					<tbody>
						{
							...
							<tr key={index}>
								<td>
									<tr><Link to={'/restaurants/'+review.split("/")[1]}>{review.split("/")[0]}</Link></tr>
						    	</td>
						    	<td>
									<tr>{review.split("/")[2]}/5</tr>
						    	</td>
						    	<td>
									<tr>{review.split("/")[3]}</tr>
						    	</td>
					    	</tr>
					    	))}
					</tbody>
			...
			<div>
				<ListGroup>
					<ListGroupItem header="Profile Picture">
						<img className="profile-photo" src={this.state.images[this.state.images.length-1]}/><br></br>
